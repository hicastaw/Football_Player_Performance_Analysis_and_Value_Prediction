...
# Danh sách các trang và id bảng
website = {
...
for link, id in website.items():
    ...
    if table:
        ...
        # Lấy tiêu đề từ hàng đầu tiên có dữ liệu
        tables[id] = pd.DataFrame(data[1:], columns=data[0])

# Xử lý dữ liệu minutes
...
header=[
    ...
    "passing_total_cmp","passing_total_cmppct","passing_total_totdist","passing_short_cmppct","passing_medium_cmppct","passing_long_cmppct","passing_expected_kp","passing_expected_1_3","passing_expected_ppa","passing_expected_crspa","passing_expected_prgp",
    "creation_sca_sca","creation_sca_sca90","creation_gca_gca","creation_gca_gca90","defense_tackles_tkl","defense_tackles_tklw","defense_challenges_att","defense_challenges_lost","defense_blocks_blocks","defense_blocks_sh","defense_blocks_pass","defense_blocks_int",
    "possession_touches_touches","possession_touches_def_pen","possession_touches_def_3rd","possession_touches_mid_3rd","possession_touches_att_3rd","possession_touches_att_pen","possession_takeons_att",
    "possession_takeons_succpct","possession_takeons_tkldpct","possession_carries_carries","possession_carries_prgdist","possession_carries_prgc",
...
file_path = r'E:\ket_qua_bai_tap_lon\Code\results.csv'  # dùng raw string r'' để không lỗi
